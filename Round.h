...
enum Canto {NADA, P1_TRUCO, P1_RETRUCO, P1_VALECUATRO, P1_QUIERO, P1_NOQUIERO,
			P1_ENVIDO, P1_ENVIDOENVIDO, P1_REALENVIDO, P1_FALTAENVIDO, P2_TRUCO, 
			P2_RETRUCO, P2_VALECUATRO, P2_QUIERO, P2_NOQUIERO, P2_ENVIDO, 
			P2_ENVIDOENVIDO, P2_REALENVIDO, P2_FALTAENVIDO
		};
